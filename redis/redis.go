...
type Conn interface {
	...
	// DoNew sends a command to the server and returns the received reply.
	DoNew(commandName string, args []interface{}) (reply interface{}, err error)

	// Send writes the command to the client's output buffer.
	Send(commandName string, args ...interface{}) error

	// Send writes the command to the client's output buffer.
	SendNew(commandName string, args []interface{}) error
